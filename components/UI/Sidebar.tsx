  ...
  return (
    <div className="bg-light-900 text-light-50 dark:text-dark-50 dark:bg-dark-900 z-10 shadow shadow-black/30 flex">
      <ul className="flex flex-col border-r border-light-500 dark:border-dark-500 min-w-[14rem]">
          ...
          links={[
            {
              title: "Novo",
              href: "/protocolos/new",
              icon: <svg xmlns="http://www.w3.org/2000/svg" width="15" height="16" fill="currentColor" viewBox="0 0 16 16">
        ...
        />
        {
          authUser && (authUser.role === "ADMIN" || authUser.role === "SUPERADMIN") && <Dropdown
            section={{
              id: "configuracoes",
              title: "Configurações",
              icon: <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
