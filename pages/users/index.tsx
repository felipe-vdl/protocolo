...
interface RowActionsProps {
  user: { id: number; is_enabled: boolean; role: Role };
  authUser: UserInfo;
}
const RowActions = ({ user, authUser }: RowActionsProps) => {
  ...
  return (
    <div className="flex gap-2">
      {user.role === "SUPERADMIN" && authUser.role === "SUPERADMIN" ? (
        <>
          <button
...
const UserCreate = ({ authUser, users }: UserIndexProps) => {
