    ...
    try {
      ...
      if (result.success) {
        ...
        setForm({
          ...
          ddd: updatedProtocolo.telefone ? updatedProtocolo.telefone.slice(2, 4) : "",
          telefone: updatedProtocolo.telefone ? updatedProtocolo.telefone.slice(4) : "",
...
export const getServerSideProps: GetServerSideProps<EditProtocoloProps> = async (context) => {
